...
a discussion on the issues tracker. If it mirrors a similar feature in another
browser, let us know. Once you've picked something to work on, add a comment to the
...
Please include the following when reporting an issue:
 ...
 1. Owl Version: `chrome://extensions`

## Installing From Source

Owl is written in Coffeescript, which compiles to Javascript. To
install Owl from source:
...
## What makes for a good feature request/contribution to Owl?

Good features:

* Useful for lots of Owl users
...
* Are very niche, and so aren't useful for many Owl users
* Require explanation
...
If you're worried that a feature you plan to build won't be a good fit for core Owl, just open a github
issue for discussion or send an email to the Owl mailing list.

## How to release Owl to the Chrome Store
